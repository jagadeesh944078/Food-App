...
import { addTheme } from "../utils/darkThemeSlice";
...
const Header = () => {
  ...
  return (
    <div
      className={`flex justify-between px-5 border ${
    ...
    >
      ...
      <div>
        <ul className="flex my-8">
          ...
          <li className="p-2 font-bold hover:text-orange-500">
            <Link
              to="/about"
          ...
          <button
            className={`rounded-md font-bold border p-2 ${
              isDarkTheme ? "border border-white" : "border border-black"
            }`}
            onClick={() => {
              dispatch(addTheme());
            }}
          >
            {isDarkTheme ? "☀️Light" : "🌙Dark"}
          </button>
        </ul>
      </div>
    </div>
